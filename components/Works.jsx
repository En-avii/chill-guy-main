    ...
    <section className="xl:my-36 md:mx-36 p-8 " id="projects">
      ...
      <div className="w-full flex">
        <motion.p
          ...
          viewport={{ once: true, amount: 0.25 }}
        >
         These projects highlight my hands-on expertise and technical experience,
         featuring detailed descriptions, code repositories, and live demos.
         They reflect my capability to tackle complex problems, work with
         diverse technologies, and manage projects from conception to completion.
        </motion.p>
      </div>
